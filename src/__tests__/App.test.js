...
test("the page shows information the user types into the contact form field", () => {
  ...
  userEvent.type(contactName, "Adan");
  userEvent.type(contactEmail, "adan@example.com");

  expect(contactName).toHaveValue("Adan");
  expect(contactEmail).toHaveValue("adan@example.com");
});
...
test("the page shows information the user types into the name and email address form fields", () => {
  ...
  userEvent.type(nameInput, "Adan Bashir");
  userEvent.type(emailInput, "adan.bashir@example.com");

  expect(nameInput).toHaveValue("Adan Bashir");
  expect(emailInput).toHaveValue("adan.bashir@example.com");
});
